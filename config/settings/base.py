...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres:///oauth_backend",
    ),
}
...
MIGRATION_MODULES = {"sites": "oauth_backend.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "oauth_backend.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""Matheus e Yasmin""", "matheus-e-yasmin@example.com")]
...
ACCOUNT_FORMS = {"signup": "oauth_backend.users.forms.UserSignupForm"}
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Documentation of API endpoints of oauth-backend",
    "VERSION": "1.0.0",
